    ...
    <view :class="isUps == true ? 'prevent' : ''">
        ...
        <view class="uni-common-mt" id="goods">
            ...
            <view class="uni-flex uni-row" style="-webkit-flex-wrap: wrap;flex-wrap: wrap;">
                <view class="text modeller"><image src="/static/logo.png" style="width: 40px;height: 40px;"></image>海尔滚筒洗衣机BCD-150WLDPEK风冷两门风冷除菌（自动除霜）念白360度全白色滚筒洗衣机，高温杀菌高品质简约设计。</view>
            </view>
            ...
            <pro-com-act :isShowAct="ActType==='OPEN'" @closeAct="showAct('')" @checkedAct="checkedAct"></pro-com-act>
            <view class="lineHigt"></view>
            <view class="uni-flex uni-row">
...
<script>
    import uniSwiperDot from "../../components/uniUi/uni-extend/uni-swiper-dot";
